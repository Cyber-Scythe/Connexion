...
public class CheckDbForUserLambda extends LambdaActivityRunner<CheckDbForUserActivityRequest, CheckDbForUserActivityResult>
        implements RequestHandler<AuthenticatedLambdaRequest<CheckDbForUserActivityRequest>, LambdaResponse> {
    @Override
    public LambdaResponse handleRequest(AuthenticatedLambdaRequest<CheckDbForUserActivityRequest> input, Context context) {
