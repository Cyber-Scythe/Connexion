...
public class GetMessagesWithUserLambda
        ...
        implements RequestHandler<AuthenticatedLambdaRequest<GetMessagesWithUserActivityRequest>,
    LambdaResponse> {

    private final Logger log = LogManager.getLogger();

    @Override
    public LambdaResponse handleRequest(AuthenticatedLambdaRequest<GetMessagesWithUserActivityRequest> input,
                                            Context context) {
        return super.runActivity(() -> {
                //GetMessagesFromUserActivityRequest unauthenticatedRequest =
                // input.fromBody(GetMessagesFromUserActivityRequest.class);
