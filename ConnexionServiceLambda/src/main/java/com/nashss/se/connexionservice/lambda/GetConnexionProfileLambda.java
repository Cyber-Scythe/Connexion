...
public class GetConnexionProfileLambda
        ...
        implements RequestHandler<AuthenticatedLambdaRequest<GetConnexionProfileActivityRequest>, LambdaResponse> {

    private final Logger log = LogManager.getLogger();

    @Override
    public LambdaResponse handleRequest(AuthenticatedLambdaRequest<GetConnexionProfileActivityRequest> input, Context context) {
